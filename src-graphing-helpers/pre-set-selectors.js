...
//         c.type === 'color' ?
//           thisLayer.color :
//           !thisLayer.style ? c.defaultValue :
//             typeof thisLayer.style[c.key] === 'boolean' && thisLayer.style[c.key] ? 'true' :
//               typeof thisLayer.style[c.key] === 'boolean' ? 'false' :
//                 !thisLayer.style[c.key] ? c.defaultValue :
//                   thisLayer.style[c.key] ;

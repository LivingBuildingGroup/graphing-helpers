...
describe('pre-set-edit', ()=> { 
  ...
  it('editOnePreSetStyle returns {} if input not an object', () => {
    const input = 'not an object';
    const expectedResult = {};
    const result = editOnePreSetStyle(input);
    expect(result).to.deep.equal(expectedResult);
  });
  it('editOnePreSetStyle returns {} if styles not an object', () => {
    const input = {
      value: 'false',
      layer: 'layer2',
      preSetGlobalPalette,
  ...
  it('editOnePreSetStyle returns input if property not an object', () => {
    const input = {
      styles: manyStyles,
      value: 'false',
      layer: 'layer2',
  ...
  it('editOnePreSetStyle returns input if layer not a string', () => {
    const input = {
      styles: manyStyles,
      value: 'false',
      layer: ['not a string'],
  ...
  it('editOnePreSetStyle boolean fill false', () => {
    const input = {
      styles: manyStyles,
      value: 'false',
      layer: 'layer2',
  ...
  it('editOnePreSetStyle boolean fill true', () => {
    const input = {
      styles: manyStyles,
      value: 'true',
      layer: 'layer2',
  ...
  it('editOnePreSetStyle array borderDash', () => {
    const input = {
      styles: manyStyles,
      value: [10,10],
      layer: 'layer2',
  ...
  it('editOnePreSetStyle stringified array borderDash', () => {
    const input = {
      styles: manyStyles,
      value: '10,10',
      layer: 'layer2',
  ...
  it('editOnePreSetStyle number opacityBackground', () => {
    const input = {
      styles: manyStyles,
      value: 0.23,
      layer: 'layer2',
  ...
  it('editOnePreSetStyle shade > 0 changes color, colorOld, shade', () => {
    const input = {
      styles: manyStyles,
      value: 3,
      layer: 'layer2',
  ...
  it('editOnePreSetStyle shade > 0 changes color, colorOld, shade, preSetGlobalPalette not an array so uses default color', () => {
    const input = {
      styles: manyStyles,
      value: 3,
      layer: 'layer2',
  ...
  it('editOnePreSetStyle shade = 0 shade starting with no colorOld', () => {
    const input = {
      styles: manyStyles,
      value: 0,
      layer: 'layer2',
  ...
  it('editOnePreSetStyle shade = 0 color reverts to colorOld', () => {
    const input = {
  ...
  it('editOnePreSetStyle color changes color, colorOld, shade=0', () => {
    const input = {
      styles: manyStyles,
